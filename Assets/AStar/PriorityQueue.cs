...
/*
 * original src file https://github.com/luxkun/ReGoap/blob/master/ReGoap/Planner/FastPriorityQueue.cs
 * here makes a little modification
 */
public sealed class PriorityQueue<T> where T : class, IPriorityQueueNode {
        ...
        public void Enqueue(T node, float priority)
        {
            ...
            // enable dynamic increase capacity
        ...
        /// O(n)
        /// </summary>
        private void Resize(int maxNodes)
        {
#if DEBUG
            if (maxNodes <= 0)
            {
